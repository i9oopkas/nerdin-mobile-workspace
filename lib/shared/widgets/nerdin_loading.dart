...
/// Standard loading indicators following Nerdin design patterns
class NerdinLoading {
    ...
    return _LoadingIndicator(
      ...
      color:
          ...
          (context?.nerdinTheme.buttonPrimaryText ??
              context?.nerdinTheme.textPrimary ??
...
class _LoadingIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final resolvedColor = color ?? context.nerdinTheme.loadingIndicator;
  ...
  Widget build(BuildContext context) {
    return Container(
      color: darkBackground
          ? context.nerdinTheme.surfaceBackground.withValues(
              alpha: Alpha.strong,
            )
          : context.nerdinTheme.surfaceBackground.withValues(
              alpha: Alpha.intense,
      ...
      child: Center(
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: NerdinShadows.high(context),
          ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: context.nerdinTheme.shimmerBase,
      ),
          ...
          return Container(
            decoration: BoxDecoration(
              ...
              gradient: LinearGradient(
                ...
                colors: [
                  Colors.transparent,
                  context.nerdinTheme.shimmerHighlight,
                  Colors.transparent,
                ],
                stops: [
...
class LoadingButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AdaptiveButton.child(
      ...
      color: isPrimary ? context.nerdinTheme.buttonPrimary : null,
      style: AdaptiveButtonStyle.filled,
      child: isLoading ? NerdinLoading.button(context: context) : child,
    );
  }
}

/// Refresh indicator with Nerdin styling.
///
...
class NerdinRefreshIndicator extends StatelessWidget {
  final Widget child;
      ...
      children: [
        SizedBox(
          ...
          child: LinearProgressIndicator(
            ...
            backgroundColor: context.nerdinTheme.dividerColor,
            valueColor: AlwaysStoppedAnimation<Color>(
              context.nerdinTheme.buttonPrimary,
            ),
          ),
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        ...
        if (isLoading)
          Container(
            color: context.nerdinTheme.surfaceBackground.withValues(
              alpha: Alpha.overlay,
            ),
            child: Center(
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: NerdinShadows.card(context),
                ),
