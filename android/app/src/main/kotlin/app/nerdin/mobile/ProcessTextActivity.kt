 ...
 * ACTION_SEND intent targeted at MainActivity so the native share receiver
 * processes it uniformly.
 */
class ProcessTextActivity : Activity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val sendIntent = Intent(Intent.ACTION_SEND).apply {
            ...
            // Route directly to MainActivity so the share receiver sees it.
